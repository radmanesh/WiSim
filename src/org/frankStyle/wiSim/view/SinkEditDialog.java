 ...
 * 
 */
public class SinkEditDialog extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2799472931843123694L;
	private final JPanel contentPanel = new JPanel();
	private final ComponentSinkNode node;
	 ...
	 * Create the dialog.
	 */
	public SinkEditDialog(ComponentSinkNode node_, Window parent, String title) {
	...
	void init() {
		...
		txtMobilityModel.setText(node.getSinkMobilityModel());
	...
	public void updateSensor() {
		...
		node.setSinkMobilityModel((txtMobilityModel.getText()));
